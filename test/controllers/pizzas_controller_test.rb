...
class PizzasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pizza" do
    assert_difference('Pizza.count') do
      post pizzas_url, params: { pizza: { crust: @pizza.crust, recipe_id: @pizza.recipe_id } }
    end
  ...
  test "should update pizza" do
    patch pizza_url(@pizza), params: { pizza: { crust: @pizza.crust, recipe_id: @pizza.recipe_id } }
